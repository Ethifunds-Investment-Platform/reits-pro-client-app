...
export default function InvestorMetrics() {
  ...
  const totalInvested = figureConverter(data?.total_invested, { currency: currency, precision: 2 });
  const portfolioValue = figureConverter(data?.portfolio_value, { currency: currency, precision: 2 });
						...
						<div className="flex items-center justify-between">
							<div>
								...
								<h3 className="text-2xl font-bold mt-1">
									{isFetching || !data?.total_invested ? "..." : `${totalInvested}`}
								</h3>
							</div>
					...
					<CardContent className="pt-6">
						<div className="flex items-center justify-between">
							<div>
								...
								<h3 className="text-2xl font-bold mt-1">
									{isFetching || !data?.portfolio_value ? "..." : `${portfolioValue}`}
								</h3>
							</div>
					...
					<CardContent className="pt-6">
						<div className="flex items-center justify-between">
							<div>
								...
								<h3 className="text-2xl font-bold mt-1">
									{isFetching || !data?.total_projects ? "..." : data?.total_projects}
								</h3>
							</div>
					...
					<CardContent className="pt-6">
						<div className="flex items-center justify-between">
							<div>
								...
								<h3 className="text-2xl font-bold mt-1">
									{isFetching || !data?.average_return ? "..." : `${data?.average_return}%`}
								</h3>
							</div>
